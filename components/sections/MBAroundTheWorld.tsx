    ...
    <section id="global-network" className="py-24 lg:py-32 bg-white relative border-b border-neutral-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 mb-12">
          <span className="text-xs font-display font-black text-maple-red uppercase tracking-[0.2em]">06 / GLOBAL NETWORK</span>
        ...
        {/* Editorial Stats Grid separated by border lines */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border-t border-b border-neutral-200 divide-y sm:divide-y-0 sm:divide-x divide-neutral-200">
          {stats.map((item, idx) => (
            <div
              key={idx}
              className="p-8 hover:bg-[#FDFBF7] transition-colors space-y-4"
            >
