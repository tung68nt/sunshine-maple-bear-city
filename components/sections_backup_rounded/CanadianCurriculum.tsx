    ...
    <section id="curriculum" className="py-24 lg:py-32 bg-[#FDFBF7] relative border-b border-neutral-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Left Column: Image Frame with Soft Rounded Corners (5 cols) */}
          <div className="lg:col-span-5 relative">
            <div className="relative h-[440px] sm:h-[500px] rounded-3xl overflow-hidden shadow-xl border border-neutral-200 bg-neutral-900">
              <Image
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-white/95 backdrop-blur-md border border-neutral-200 text-[#1D1D1B] space-y-1">
