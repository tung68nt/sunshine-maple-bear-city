...
{fontface}
{fcls}
html,body{{margin:0;background:#f5ede2;min-height:100vh}}
.cv{{container-type:inline-size;width:100%;max-width:1024.5px;margin:0 auto;position:relative;background:#fff8ee;box-shadow:0 0 50px rgba(48,66,84,0.08),0 0 1px rgba(48,66,84,0.1);overflow:hidden}}
...
.cv-menu-panel{{position:absolute;top:0;right:0;height:100%;width:min(85vw, 360px);max-width:360px;container-type:inline-size;background:#fff8ee;overflow:auto;box-shadow:-4px 0 24px rgba(48,66,84,0.15);animation:cvSlide .35s cubic-bezier(.2,.7,.2,1)}}
